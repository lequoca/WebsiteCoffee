...
namespace WebsiteCoffee.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult DatHang(FormCollection donhangForm)
        {
            ...
            using (var db = new WebsiteCoffeeEntities1())
            {
                try
                {
        ...
        {
            var toAddress = "94quocanh1872003@gmail.com"; // Địa chỉ email nhận thông báo
            var fromAddress = "94quocanh1872003@gmail.com"; // Địa chỉ email gửi thông báo
...
";
            ...
            {
                Credentials = new NetworkCredential("94quocanh1872003@gmail.com", "wwat cumo ndxe huef"), // Sử dụng mật khẩu ứng dụng
                EnableSsl = true
            };
